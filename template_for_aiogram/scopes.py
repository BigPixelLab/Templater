...
def message_list_assembler() -> Generator[MessageRenderList, MessageRender, None]:
...
MESSAGES = ParsingScope(message_list_assembler)


def message_assembler() -> Generator[MessageRender,
                                     Union[ImageID, ImageFile, AnimationID, AnimationFile, BlockText, InlineText,
...
def text_assembler() -> Generator[str, Union[BlockText, InlineText], None]:
    layout = TextLayout()
